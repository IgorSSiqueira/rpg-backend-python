...
class Itens:
    ...
    def __init__(self, nome_personagem):
        ...
        if nome_personagem not in Itens._itens:
            Itens._itens[nome_personagem] = {
                1:  {'cod': 1 , 'nome': 'Potion'            , 'quantidade': 0, 'cura': POTION, 'drop_chance': 10, 'custo_compra': 100, 'custo_venda': 30},
                ...
                9:  {'cod': 9 , 'nome': 'Cetro Mágico'      , 'quantidade': 0, 'dano_min': 20, 'dano_max': 30 , 'maos': 2, 'tipo_bonus': 'int', 'bonus': 45, 'tipo_especial': 'restaura_mana', 'especial': 50 , 'desc_esp': 'Restaura 50 de mana quando mata um inimigo', 'drop_chance': 1  , 'custo_compra': 3000, 'custo_venda': 1},
                10: {'cod': 10, 'nome': 'Espada Vampírica'  , 'quantidade': 0, 'dano_min': 20, 'dano_max': 300, 'maos': 1, 'tipo_bonus': 'str', 'bonus': 30 , 'tipo_especial': 'roubo_vida'   , 'especial': 100, 'desc_esp': 'Restaura 100% do dano realizado'           , 'drop_chance': 0.5, 'custo_compra': 5000, 'custo_venda': 1},
            }
    ...
    def verificar_usar_pocao(cls, nome_personagem, hp_atual, hp_max, mp_atual, mp_max, xp_atual, xp_level_up):
        if nome_personagem in cls._itens:
            ...
            pocao_utilizada = retornar_usar_pocao(nome_personagem, potion, hipotion, manapotion, hp_atual, hp_max, mp_atual, mp_max, xp_atual, xp_level_up)
